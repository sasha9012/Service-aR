...
namespace ServiceStationWebApp.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarModelID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarModelName = table.Column<string>(maxLength: 100, nullable: false),
                    ExtName = table.Column<string>(maxLength: 50, nullable: false),
                    BrandID = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            var backup = Path.Combine(".\\DBScripts", @"backup.sql");

            using (var reader = new StreamReader(backup, System.Text.Encoding.UTF8))
            {
